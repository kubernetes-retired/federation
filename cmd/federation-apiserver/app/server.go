...
import (
	...
	"k8s.io/federation/pkg/generated/openapi"
...
func postProcessOpenAPISpecForBackwardCompatibility(s *spec.Swagger) (*spec.Swagger, error) {
	compatibilityMap := map[string]string{
		...
		"v1beta1.ClusterCondition":         "io.k8s.federation.apis.federation.v1beta1.ClusterCondition",
		...
		"v1beta1.ClusterStatus":            "io.k8s.federation.apis.federation.v1beta1.ClusterStatus",
		...
		"v1beta1.ClusterList":                  "io.k8s.federation.apis.federation.v1beta1.ClusterList",
		"v1.KeyToPath":                         "io.k8s.kubernetes.pkg.api.v1.KeyToPath",
		"intstr.IntOrString":                   "io.k8s.apimachinery.pkg.util.intstr.IntOrString",
		"v1beta1.ClusterSpec":                  "io.k8s.federation.apis.federation.v1beta1.ClusterSpec",
		...
		"v1beta1.ServerAddressByClientCIDR":    "io.k8s.federation.apis.federation.v1beta1.ServerAddressByClientCIDR",
		...
		"v1beta1.Cluster":                      "io.k8s.federation.apis.federation.v1beta1.Cluster",
