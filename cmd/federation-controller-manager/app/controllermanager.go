...
import (
	...
	"k8s.io/federation/cmd/federation-controller-manager/app/options"
...
func Run(s *options.CMServer) error {
	...
	recorder := eventBroadcaster.NewRecorder(legacyscheme.Scheme, v1.EventSource{Component: "controller-manager"})
