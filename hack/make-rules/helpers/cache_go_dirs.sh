...
function kfind() {
    ...
    find -H . ./vendor/k8s.io/kubernetes ./vendor/k8s.io/api ./vendor/k8s.io/apimachinery \
        \(                         \
        -not \(                    \
            \(                     \
                -path ./vendor -o  \
                ...
                -path ./.\* -o     \
                -path ./docs -o    \
                -path ./vendor/k8s.io/kubernetes/staging -o   \
                -path ./vendor/k8s.io/kubernetes/docs         \
                -path ./vendor/k8s.io/kubernetes/examples     \
                -path ./vendor/k8s.io/kubernetes/third_party  \
            \) -prune              \
        \)                         \
        \)                         \
        "$@"
